...
INSERT INTO `annonce` VALUES (2,'hhhhhh',1,19,'zzzz'),(3,'discription test',1,19,'1'),(4,'discription test',1,2,'1'),(5,'discription test',1,18,'1'),(6,'discription test',1,18,'2'),(7,'discription test',1,19,'ville test'),(8,'discription test',1,2,'ville test');
...
INSERT INTO `cours` VALUES (2,'1','2','ccc'),(18,'1','2','fffff'),(19,'niveau test','type test','libelle test'),(20,'niveau test','type test','libelle test'),(21,'niveau test','type test','libelle test'),(22,'niveau test','type test','libelle test'),(25,'niveau test','type test','libelle test'),(28,'niveau test','type test','libelle test'),(32,'niveau test','type test','libelle test'),(35,'niveau test','type test','libelle test'),(38,'niveau test','type test','libelle test');
...
INSERT INTO `personne` VALUES (1,'dddd','qqqq','tttt','eeee'),(2,'sssss','xxxxx','zzzzz','vvvvv'),(3,'nom test','prenom test','pwd test','email test'),(4,'nom test','prenom test','pwd test','email test'),(5,'nom test','prenom test','pwd test','email test'),(6,'nom test','prenom test','pwd test','email test'),(7,'nom test','prenom test','pwd test','email test'),(8,'nom test','prenom test','pwd test','email test'),(9,'nom test','prenom test','pwd test','email test');
...
-- Dump completed on 2015-07-04  3:56:47
